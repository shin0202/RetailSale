...
public class GsonJSONRequest extends Request<JSONObject>
{
    ...
    public GsonJSONRequest(int method, String url, Map<String, String> params, Listener<JSONObject> listener,
    ...
    protected Response<JSONObject> parseNetworkResponse(NetworkResponse response)
    {
        try
        {
            ...
            return Response
                    .success(gson.fromJson(json, JSONObject.class), HttpHeaderParser.parseCacheHeaders(response));
        }
